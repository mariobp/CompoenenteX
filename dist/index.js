...
var CallService = (function () {
    ...
    CallService.prototype.getOptions = function (headersList, par) {
        ...
        if (!!par) {
            var /** @type {?} */ query = new URLSearchParams();
...
FormComponent.propDecorators = {
    ...
    'icon': [{ type: Input },],
    'columns': [{ type: Input },],
    'renderinputs': [{ type: Input },],
    'form': [{ type: Input },],
    'service': [{ type: Input },],
    'deleteable': [{ type: Input },],
    'saveable': [{ type: Input },],
    'otro': [{ type: Input },],
    'debug': [{ type: Input },],
    'retur': [{ type: Input },],
...
BaseComponent.decorators = [
    { type: Component, args: [{ template: "<div class=\"wrapper\"> <ex-sidebar> <ex-navbar mobile=\"true\"></ex-navbar> </ex-sidebar> <div class=\"main-panel\"> <ex-toolbar title=\"Nomina\"> <ex-navbar right=\"true\"></ex-navbar> </ex-toolbar> <div class=\"main-content\"> <ex-miga></ex-miga> <router-outlet></router-outlet> </div> </div> </div> " },] },
];
/**
 * @nocollapse
 */
...
export { SampleModule, SampleComponent, SampleDirective, SamplePipe, SampleService, CallService, CrudBase, CrudService, FormComponent, TableComponent, P404Component, BaseComponent, BsNotify };
